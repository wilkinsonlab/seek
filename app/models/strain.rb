...
class Strain < ActiveRecord::Base
  ...
  validates_presence_of :projects, unless: proc { |strain| strain.is_dummy? || Seek::Config.is_virtualliver }
  ...
  def clone_with_associations
    ...
    new_object.projects = projects
    new_object.genotypes = genotypes
    new_object.phenotypes = phenotypes
