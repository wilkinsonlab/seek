...
class JsonMetaTest < ActiveSupport::TestCase
  ...
  test "metadata contents for publication" do
    item = Factory :publication, :doi=>"10.1002/0470841559.ch1", :pubmed_id=>nil
    json = Seek::ResearchObjects::JSONMetadata.instance.metadata_content(item)
    json = JSON.parse(json)
    ...
    assert_equal "10.1002/0470841559.ch1",json["doi"]
    assert_equal "https://dx.doi.org/10.1002/0470841559.ch1",json["doi_uri"]
